    ...
    <div>
      ...
      <div className="bg-whiteBg p-[8vh]">
        <div className="flex justify-around">
          ...
          <div>
            <button className="bg-red text-textWhite rounded-full  mt-2">
              {" "}
              Read All Articles
            </button>
          </div>
        ...
        {/* <div className="grid grid-cols-2 pt-16 pl-16 ">
          <div>
            <card className=" rounded-xl bg-red ">
              <img className="w-[636px] h-[486px]" alt="" src="./burger.png"></img>
              <div className="bg-white p-4 w-[636px]  rounded-b-xl  shadow-2xl ">
                <h1 className="text-start  text-textGray  ">
                  January 3,2023
                  <h1 className="text-black mt-4 font-semibold  ">
                    The Strict tips & tricks to prepare a perfect burger & pizza
                    for our Customers.{" "}
                  </h1>
                  <h1 className="text-textGrayy mt-4">
                    Lorem ipsum dolor sit amet consectetur of a adipiscing
                    elitimim semper adipiscing massa gravida nisi cras enim quis
          ...
          <div className="grid grid-cols-2 ">
            <card>
              <img className="" alt="" src="./pasta.png"></img>
            ...
            <card className="">
              <img className="" alt="" src="./pizza.png"></img>
              <div className="bg-white p-4 w-[305px]  rounded-b-xl  shadow-2xl ">
                <h1 className="text-start  text-textGray  ">
                  January 3,2023
                  <h1 className="text-black mt-4 font-semibold">
                     5 great pizza restaurent you should visit this city.
                  </h1>
                </h1>
              </div>
            </card>
            <card>
              <img className="" alt="" src="./cookies.png"></img>
              <div className="bg-white p-4 w-[305px]  rounded-b-xl  shadow-2xl ">
                <h1 className="text-start  text-textGray  ">
                  January 3,2023
                  <h1 className="text-black mt-4 font-semibold">
                     7 Delecious cheesecake recipes you can prepare.
                  </h1>
                </h1>
              </div>
            </card>
            <card className="">
              ...
              <div className="bg-white p-4 w-[305px]  rounded-b-xl  shadow-2xl ">
                <h1 className="text-start  text-textGray  ">
                  January 3,2023
                  <h1 className="text-black mt-4 font-semibold">
                     How to prepare delectable chicken tenders.
                  </h1>
                </h1>
              </div>
            </card>
